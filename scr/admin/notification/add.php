...
<?php
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        NotificationDB::AddNofification($_POST['ten_thong_bao'], $_POST['noi_dung'], serialize($imageLists));
                    ...
                    <form class="row" method="POST" enctype="multipart/form-data">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="ten_thong_bao" class="form-control" required>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea name="noi_dung" style="height: 125px" class="form-control" required></textarea>
                            </div>
                        </div>
                        <div class="col-md-12">
