...
<?php
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        DoctorDB::UpdateDoctor($_POST['ma_bac_si'], $_POST['ten_bac_si'], '', $_POST['email']);
        header('Location: ' . URL_ROOT . '/admin/doctor/');
    }

    if ($_SERVER['REQUEST_METHOD'] == 'GET') {
        $doctorData = DoctorDB::GetDataByID($_GET['id']);
    }
?>
                    ...
                    <form class="row" method="POST">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="ma_bac_si" class="form-control" value="<?=$doctorData['ma_bac_si']?>" readonly>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Tên bác sĩ</label>
                                <input type="text" name="ten_bac_si" class="form-control" value="<?=$doctorData['ten_bac_si']?>" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
